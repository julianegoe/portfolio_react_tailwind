...
function Home() {
	...
	return (
		<div className='grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 xl: 2xl:grid-cols-2'>
			...
			<div className='sm:col-span-1 md:col-start-1 md:col-span-1 lg:col-start-2 lg:col-span-1 xl:col-start-2 xl:col-span-1 width-1/2 h-screen bg-gray-100'>
